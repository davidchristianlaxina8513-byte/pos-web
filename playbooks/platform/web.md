...
> **Web-track (advisory):** pos-app's current baseline is Expo React Native, mobile-only (see `CONTEXT.md` → Product Decisions). This playbook activates with the planned web migration; until then it is reference only.
